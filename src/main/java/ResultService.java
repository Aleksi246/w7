...
public class ResultService {
    ...
    private static final String DB_USER = "calcuser";
    private static final String DB_PASSWORD = "calcpass";
    ...
    public static void saveResult(double n1, double n2, double sum, double product, double subtraction, double division) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, DB_USER, DB_PASSWORD);
            ...
            try (PreparedStatement ps = conn.prepareStatement(insert)) {
                ...
                ps.setDouble(2, n2);
                ps.setDouble(3, sum);
                ps.setDouble(4, subtraction);
                ps.setDouble(5, division);
                ps.setDouble(6, product);
                ps.executeUpdate();
            }

            System.out.println("✅ Result saved: " + n1 + ", " + n2 + " → Sum=" + sum +", Subtraction=" + subtraction + ", Division=" + division + ", Product=" + product);
